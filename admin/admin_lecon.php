...
<div id="id01" class="w3-modal">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                ...
                <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
                        <div class="title">
                               <b> Ajouter une lecon</b>
                                </div>
                   </div>
          <form class="w3-container" action="ajoutfile.php" method="POST" enctype="multipart/form-data">
            
            <div class="w3-section">
                   
              <div class="inputfield"><label><b>contenu de cours</b></label>
              <input class="w3-input w3-border" type="file"   name="fichier" required><br><br>
             
             </div></div> <label><b>seuls les fichiers PDF sont autorisées</b></label>
...
<table id="customers">
        <tr>
                <th> les lecons PDF</th>
            </tr>  
<tr>
<th id=c>Titre</th>
<th id=c>Contenu du cours</th>
<th id=c>control</th>
</tr>
<?php 
require('connexion.php');
       ...
       foreach ($res as $row){ 
        ...
        echo '<tr>
        <td>'.$row['name'].'</td>
        <td><a href="'.$row['file_url'].'" class="btn btn-warning" ><img src="https://img.icons8.com/dusk/64/000000/show-property.png" style="width:30px;"/></a> </td>
        <td><a href=suppcourse.php?id='.$row['id'].'><img src="delete.jpg" width="25px" height="25px"></a></td> 
        </tr>
        <tr>'; 
...
<div class="w3-container">
<button onclick="document.getElementById('id02').style.display='block'"  class="button" ><span>Ajouter </span></button> 
...
<div id="id02" class="w3-modal">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
          ...
          <form class="w3-container" action="ajoutvideo.php" method="POST" enctype="multipart/form-data">
            
            <div class="w3-section">
                   
              <div class="inputfield"><label><b>video</b></label>
              <input class="w3-input w3-border" type="file"   name="file" required><br><br>
             
             </div></div> <label><b>seuls les fichiers MP4 sont autorisées</b></label>
    ...
    <br>
          <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
          <input type="submit" class="w3-button w3-red" name="ajoute" value="Ajouter">
            <button onclick="document.getElementById('id02').style.display='none'" type="button" class="w3-button w3-red">Fermer</button>
           </div></form>
...
require('connexion.php');
       ...
       foreach ($res as $row){ 
        ...
        echo '<tr>
        <td>'.$row['name'].'</td>
        <td><a href="upload/'.$row['name'].'" class="btn btn-warning" ><img src="https://img.icons8.com/dusk/64/000000/show-property.png" style="width:30px;"/></a> </td>
        <td><a href=suppvideo.php?id='.$row['id'].'><img src="delete.jpg" width="25px" height="25px"></a></td> 
        </tr>
        <tr>'; 
