...
<div class="wrapper">
    ...
    <a href="http://localhost/speakEnglish/admin/admin.php"><img src="logo.png" style="widows: 100px;"></a>
        <h2>Votre espace</h2>
        <ul>
            <li><a href="http://localhost/speakEnglish/admin/adminprofileMenu.php"><i class="fas fa-user"></i>Compte</a></li>
            <li><a href="http://localhost/speakEnglish/admin/admin_lecon.html"><i class="fas fa-book-reader"></i>Leçons</a></li>
            <li><a href="http://localhost/speakEnglish/admin/admin_user.php"><i class="fas fa-book-reader"></i>Utilisateurs</a></li>
           <!--  saraha ma3rftch yakma nsit chi haja ola la hta tchofi -->
            <li><a href="file:///C:/wamp64/www/speakEnglish/login.html"><i class="fas fa-sign-out-alt"></i>Déconnexion</a></li>
